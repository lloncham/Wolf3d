...
/*   Updated: 2019/02/27 15:29:10 by lloncham         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	mlx_put_image_to_window(r->img_data, r->win, r->text, 0, 0);
}
...
int		main(int ac, char **av)
{
	...
	raycast(&ptr);
	//
	ptr.text = mlx_xpm_file_to_image(ptr.mlx, "../xpm/test.XPM", &lar, &lon);
	mlx_put_image_to_window(ptr.img_data, ptr.win, ptr.text, W/2, H/2);
	mlx_put_image_to_window(ptr.img_data, ptr.win, ptr.text, W/2, H/2);
	//
